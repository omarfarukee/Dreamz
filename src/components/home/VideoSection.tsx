...
export default function VideoSection() {
    ...
    useEffect(() => {
        ...
        // Shrink video back when scrolling up
        gsap.fromTo(
            ".video",
            { width: "90%" },
            {
    ...
    return (
        <div className="flex min-h-[100vh] justify-center items-center relative">
            ...
            <h1 className="text-[20em] font-bold uppercase absolute top-[5%] text-[#ff34340c]">
                Dreamz
            </h1>
            ...
            <video
                ...
                className="video transition-all duration-300 ease-out rounded-lg z-10"
                loop
                controls // ✅ Adds built-in video controls
                src={slides[0].video} // ✅ Removed 'autoPlay' so it starts only in view
            />
